...
(defun test-skip-only-rule-skip-test-precedes-only-test (a-done)
...
(defun test-skip-only-rule-skip-test-precedes-only-test-recursive (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1))
...
(defun test-skip-only-rule-skip-test-precedes-only-suite (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1
...
(defun test-skip-only-rule-skip-only-suite-not-precedes-skip-suite (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1
...
(defun test-skip-only-rule-skip-suite-precedes-only-test (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1
...
(defun test-skip-only-rule-skip-suite-precedes-only-suite (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1
...
(defun test-skip-only-rule-skip-suite-precedes-only-test-and-only-suite (a-done)
  (let* ((runner-instance (make-runner))
         (suite-root (suite-root runner-instance))
         (suite-1 (create-suite runner-instance
                                :suite-1
